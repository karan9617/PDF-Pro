...
public class DBHandler4 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "contactsManager2111";
    private static final String TABLE_CONTACTS = "contacts2111";
    ...
    public void deleteContact(ContactsAll contact) {
        SQLiteDatabase db = this.getWritableDatabase();
        String selectQuery = "DELETE FROM "+TABLE_CONTACTS+ " WHERE "+KEY_FILE_NAME+" = "+'"'+contact.getFilename()+'"'+" AND "+KEY_FILE_PATH +" = "
                + '"'+contact.getPath()+'"';
