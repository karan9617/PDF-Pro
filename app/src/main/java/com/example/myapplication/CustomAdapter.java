...
// STAR LIST ADAPTER
public class CustomAdapter extends ArrayAdapter<ContactsAllImg>{
    ...
    public CustomAdapter(Context context, ArrayList<ContactsAllImg> array2, Context c1) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final byte[] arr = dbHandler.getByteArray(cn.getFilename(), cn.getPath());
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.star:
                        ...
                        Toast.makeText(c1, "Starred",Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.remove:
