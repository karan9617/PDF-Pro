...
public class CustomAdapter5 extends ArrayAdapter<ContactsAll> implements BaseClass{
    ...
    public CustomAdapter5(Context context, List<ContactsAll> array2) {
